...
const ContentPool: React.FC<ContentPoolProps> = ({
  ...
  return (
    ...
    >
      <button
        onClick={onUpload}
        className="mb-2 rounded bg-gradient-to-r from-[#047AC0] to-[#8EC9FF] px-4 py-2 text-sm font-semibold text-white hover:from-[#0467a0] hover:to-[#7abaff] cursor-pointer flex items-center justify-center"
      >
