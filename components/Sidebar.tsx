...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  // For inline (project-specific) settings popover:
    ...
    <div className="relative w-64 h-full p-4 border-r border-gray-300 flex flex-col">
                ...
                <div key={project.id} className="relative">
                  ...
                  {projectSettingsOpen && (
                    ...
                    >
                      ...
                      {/* Add Member Section */}
                      <div>
                        <label className="block text-xs mb-1 font-medium">Add Member by Email</label>
                        <input
                          type="email"
                          placeholder="Email"
                          value={searchEmail}
      ...
      <div className="absolute bottom-4 left-4">
        ...
        {globalSettingsOpen && (
          ...
          >
            <div>
              <label className="block text-xs mb-1 font-medium">Create a new project</label>
              <input
                type="email"
                placeholder="Email"
                value={searchEmail}
